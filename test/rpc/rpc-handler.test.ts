...
import { createRpcHandler } from '../../src/rpc/rpc-handler.js'
import { Either } from '../../src/monad/either.js'
import { Logger } from '../../src/logger/index.js'
import { RpcError } from '../../src/types/error.types.js'
import type { ValidatedJsonRpcRequest } from '../../src/types/handler.types.js'
...
describe('RPC Handler', () => {
  ...
  describe('doHandleRequest', () => {
    it('should handle successful request with direct response', async () => {
      ...
      const result = await rpcHandler.doHandleRequest(request)
