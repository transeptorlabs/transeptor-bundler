...
const findIllegalNonZeroValueCall = (callStack: CallEntry[], entryPointAddress: string): CallEntry | undefined => {
  return callStack.find(
    (call) =>
      call.to !== entryPointAddress &&
...
const extractAddresses = (callsFromEntryPoint: TopLevelCallInfo[]): string[] => {
...
const extractStorageMap = (callsFromEntryPoint: TopLevelCallInfo[]): StorageMap => {
